...
/**
 * AguaIotClient handles authentication and API calls for the Agua IOT cloud.
 */
export class AguaIotClient {
  ...
  /**
   * Register, login, and return the list of devices.
   */
  ...
  /**
   * Register the Homey installation as an Agua IOT app.
   */
  ...
  /**
   * Authenticate with the Agua IOT cloud.
   */
  ...
  /**
   * Ensure a valid token is available before API calls.
   */
  ...
  /**
   * Generic HTTP wrapper for Agua IOT endpoints.
   */
  ...
  /**
   * Retrieve all devices visible to the account.
   */
  ...
  /**
   * Fetch the register map for a specific device.
   */
  ...
  /**
   * Request a device buffer read and wait for completion.
   */
  ...
  /**
   * Write raw values to device registers.
   */
...
/**
 * AguaIotDevice wraps register state for a single stove.
 */
export class AguaIotDevice {
  ...
  /**
   * Load the register map for the device.
   */
  ...
  /**
   * Refresh the register buffer values.
   */
  ...
  /**
   * Parse a register entry, applying its formula.
   */
  getRegister(key: string): RegisterMapEntry | null {
    ...
    // Formula contains placeholders like # and Mod (modulus).
  ...
  /**
   * Retrieve a register value with vendor-specific fixes applied.
   */
  ...
  /**
   * Get the description for an enum-based register value.
   */
  ...
  /**
   * Check if a register is enabled by its associated enable register.
   */
  ...
  /**
   * Convert a user-friendly value to the raw value for writing.
   */
  ...
  /**
   * Write a single register by key.
   */
  ...
  /**
   * Write multiple registers in a single request.
   */
  ...
  /**
   * Write a value by its description (e.g. enum label).
   */
